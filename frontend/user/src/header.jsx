...
import ProfileMenu from "./toggleComponent";
            ...
            <div className="mx-5">
                <div className="flex justify-between items-center py-4">
                    ...
                    <div className="hidden md:flex items-center gap-3">
                        ...
                        { userRole === "ADMIN" && (
                            <button type="button" onClick={switchToAdmin} className="bg-white hover:bg-green-200 text-gray-800 font-semibold px-6 py-2 rounded-full transition-all duration-200 border-2 border-gray-300 hover:border-gray-400 shadow-sm hover:shadow-md"> GO TO ADMIN PAGE</button>
                        )}
