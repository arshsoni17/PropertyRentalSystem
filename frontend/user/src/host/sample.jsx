// AddProperty.jsx
// Route: /host-dashboard/add-property
...
const FIELDS = [
  { name: "title",           label: "Property title",       type: "text",     placeholder: "e.g. Cosy studio in Connaught Place", span: 2 },
  { name: "city",            label: "City",                 type: "text",     placeholder: "e.g. New Delhi",                      span: 1 },
  { name: "price_per_night", label: "Price per night (₹)",  type: "number",   placeholder: "e.g. 2500",                           span: 1 },
  { name: "max_guests",      label: "Max guests",           type: "number",   placeholder: "e.g. 4",                              span: 1 },
];
...
export default function AddProperty() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess(true);
      setTimeout(() => navigate("/host-dashboard/properties"), 2000);
    } catch (err) {
      ...
      <form onSubmit={handleSubmit} className="max-w-3xl mx-auto px-4 sm:px-6 py-10 space-y-8">
        ...
        <Section title="Description" subtitle="What makes your place special?">
          ...
          <textarea
            ...
            className={`w-full rounded-xl border px-4 py-3 text-sm text-gray-800 placeholder-gray-300 resize-none focus:outline-none focus:ring-2 focus:ring-[#FF385C] focus:border-transparent transition ${
  ...
  return (
    <div>
      ...
      <input
        ...
        className={`w-full rounded-xl border px-4 py-3 text-sm text-gray-800 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-[#FF385C] focus:border-transparent transition ${
