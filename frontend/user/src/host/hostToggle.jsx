    ...
    return (
        <>
            <div ref={menuRef} className="flex flex-col relative ">
                ...
                {isOpen == 1 &&
                    <div className=" absolute  right-0 mt-20 w-42 bg-gray-100 shadow-lg  rounded-lg p-3 z-50">
                        <button onClick={allproperties}><div className="bg-linear-to-r from-gray-100 to-gray-200 hover:from-gray-300 hover:to-gray-400  text-Black font-semibold p-3 m-2 rounded-full transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"> Add Property</div></button>
                        <button
                            type="button"
                            onClick={logout}
...
export default ProfileMenuHost;
